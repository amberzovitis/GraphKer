...
// General Info for CVEs Dataset
MERGE (i:GeneralInfo_CVE {
  Data_Type:    value.CVE_data_type, Data_Format: value.CVE_data_format,
  Data_Version: value.CVE_data_version, No_CVEs: coalesce(value.CVE_data_numberOfCVEs, ' NOT SET '),
  Timestamp:    coalesce(value.CVE_data_timestamp, ' NOT SET ')
})

// Insert CVEs
WITH value, i
FOREACH (item IN value.CVE_Items |
  MERGE (a:CVE {
